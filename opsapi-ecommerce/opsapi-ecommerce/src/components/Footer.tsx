        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4 max-w-sm">
              Your trusted multi-tenant marketplace connecting buyers and sellers worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              ...
              <li><Link href="/stores" className="text-gray-400 hover:text-white text-sm transition-colors">Stores</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              <li><Link href="/register" className="text-gray-400 hover:text-white text-sm transition-colors">Start Selling</Link></li>
              <li><Link href="/seller/stores" className="text-gray-400 hover:text-white text-sm transition-colors">Seller Dashboard</Link></li>
              <li><Link href="/help/seller-guide" className="text-gray-400 hover:text-white text-sm transition-colors">Seller Guide</Link></li>
              <li><Link href="/help/fees" className="text-gray-400 hover:text-white text-sm transition-colors">Fees & Pricing</Link></li>
            </ul>
          </div>
