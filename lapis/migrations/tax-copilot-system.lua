...
return {
    ...
    -- Pre-deduped using amount-banded strategy: grouped by (description, category,
    -- hmrc_category, business_type, profile_type, industry, transaction_type,
    -- amount_band) where bands are small (<£50), medium (£50-200), large (£200+).
    -- Keeps one representative per group → 106 diverse examples (from 355 raw rows).
    -- See scripts/dedupe_reference_data.py for the dedup generator.
