...
-- A simple counter implementation that batches increments in memory
-- and periodically flushes them to a shared dictionary.
-- This reduces the number of operations on the shared dictionary,
-- which can be a bottleneck in high-throughput scenarios.
