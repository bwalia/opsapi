-- resty.utils - Utility module for lua-resty-jwt
-- Required by resty.jwt 0.3.1 but missing from the luarocks package
-- Source: https://github.com/cdbattags/lua-resty-jwt/blob/master/lib/resty/utils.lua
