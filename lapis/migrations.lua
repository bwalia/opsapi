...
local simpro_menu_migrations = load_if_enabled(ProjectConfig.FEATURES.FIELD_SERVICE, "migrations.simpro-menu") or {}
...
local _migrations = {
    ...
    -- so `lapis config export|import` can upsert by stable key. Runs after
    -- everything else in the TAX_COPILOT block; every step is idempotent
    -- (CREATE UNIQUE INDEX IF NOT EXISTS).
    -- =========================================================================
    ['990_cmi_uq_property_line_categories'] = conditional_array(ProjectConfig.FEATURES.TAX_COPILOT, config_cmi_unique_keys_migrations, 1),
    ...
    ['914_register_simpro_modules'] = conditional_array(ProjectConfig.FEATURES.FIELD_SERVICE, simpro_menu_migrations, 1),
    ['915_seed_simpro_menu_items'] = conditional_array(ProjectConfig.FEATURES.FIELD_SERVICE, simpro_menu_migrations, 2),
    ['916_grant_simpro_platform_roles'] = conditional_array(ProjectConfig.FEATURES.FIELD_SERVICE, simpro_menu_migrations, 3),
    ['917_grant_simpro_fs_roles'] = conditional_array(ProjectConfig.FEATURES.FIELD_SERVICE, simpro_menu_migrations, 4),
    ['918_enable_simpro_menu'] = conditional_array(ProjectConfig.FEATURES.FIELD_SERVICE, simpro_menu_migrations, 5),
